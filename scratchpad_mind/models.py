"""
Data Models & Telemetry Definitions for ScratchpadMind: Structured Working Memory & Chain-of-Thought Verifier Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Chain-of-Thought (CoT) Scratchpad Architecture"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
